...
public class CommentOutboxDatabase(IConfiguration configuration) : ICommentOutboxDatabase
{
    private readonly IDbConnection _dbConnection = new SqlConnection(configuration.GetConnectionString("PostgresConnection"));
